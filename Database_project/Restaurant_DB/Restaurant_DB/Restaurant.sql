...
values
(1000, '0118399149','ahmed','10th of Ramadan City','Tomatoes'),
(2000, ' 0125533556','Nour','10th of Ramadan City','potatoes'),
(3000, '0118839939','Salma', 'Elshorouk','onions');
...
alter table restaurant_schema.staffBACKUP
add foreign key(staff_foreign)
references restaurant_schema.stockBACKUP(STbup_name)
 --invalid
...
create index order_index_date
on restaurant_schema.orders(order_id)

create index menu_index_category
on restaurant_schema.menu(meal_category)

create index staff_index_name
on restaurant_schema.staff(staff_name)

create index customer_index_name
on restaurant_schema.Customers(Customer_name)
